                        ...
                        <td colspan="2">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <b> MSSV: </b><?php echo htmlentities($row['sregno']); ?><br>
                                        <b> Họ và tên sinh viên: </b> <?php echo htmlentities($row['studentname']); ?><br>
                                        <b> Ngày đăng ký sinh viên:</b> <?php echo htmlentities($row['studentregdate']); ?><br>
                                        <b> Ngày đăng ký môn học:</b> <?php echo htmlentities($row['edate']); ?><br>
                                    </td>
                                </tr>
                            </table>
                        </td>
